...
public class Stris extends javax.swing.JPanel {
    ...
    public boolean controlla(int n1, int n2, JButton but[][]) {
        ...
        if(but[p1][p2].getText().equals(but[p1+1][p2+1].getText()) && but[p1+1][p2+1].getText().equals(but[p1+2][p2+2].getText()) && !but[p1][p2].getText().equals(""))
        {
            vittoria(n1, n2, but[p1][p2].getText());
            return false;
        }
        if(but[p1+2][p2].getText().equals(but[p1+1][p2+1].getText()) && but[p1+1][p2+1].getText().equals(but[p1][p2+2].getText())&& !but[p1+2][p2].getText().equals("")){
    ...
    public boolean controlla(JButton vit[][]) {
        ...
        if(vit[0][0].getText().equals(vit[1][1].getText()) && vit[1][1].getText().equals(vit[2][2].getText())&& !vit[0][0].getText().equals(""))
            return (true);
        if(vit[2][0].getText().equals(vit[1][1].getText()) && vit[1][1].getText().equals(vit[0][2].getText())&& !vit[2][0].getText().equals(""))
            return (true);
        return (false);
    }
    ...
    public void vittoria(int n1, int n2, String vv) {
        ...
        vitt[n1][n2].setFont(new Font("Arial", Font.BOLD, 180));

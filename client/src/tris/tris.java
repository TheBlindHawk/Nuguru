...
public class tris extends javax.swing.JPanel {
    ...
    public boolean controlla() {
        int i, y, j;
        if(but[0][0].getText().equals(but[1][1].getText()) && but[1][1].getText().equals(but[2][2].getText()) && !but[0][0].getText().equals(""))
            return (true);
        if(but[2][0].getText().equals(but[1][1].getText()) && but[1][1].getText().equals(but[0][2].getText()) && !but[2][0].getText().equals(""))
            return (true);
        ...
        for (i = 0; i < 3; i++) {
            ...
            if (c1[0].equals(c1[1]) && c1[1].equals(c1[2]) && !(c1[0].equals(""))) {
                    return (true);
            }
            if (c2[0].equals(c2[1]) && c2[1].equals(c2[2]) && !(c2[0].equals(""))) {
                    return (true);
            }
        }
        return (false);
    ...
    public void vittoria(String vv) {
        ...
        victory.setBounds(250, 50, 100, 70);
        victory.setText("VITTORIA");
